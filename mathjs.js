...
const mathjsParser = parser.configure({
    props: [
        ...
        styleTags({
            ...
            NullLiteral: t.null,
            UndefinedLiteral: t.null,
            Identifier: t.variableName,
            PropertyName: t.propertyName,
            PrefixOp: t.operator,
            PostfixOp: t.operator,
            PowOp: t.operator,
            MultiplyOp: t.operator,
            AddOp: t.operator,
            RelOp: t.compareOperator,
            ShiftOp: t.operator,
            AndOp: t.logicOperator,
            OrOp: t.logicOperator,
            XorOp: t.logicOperator,
            ConversionOp: t.operator,
            ModOp: t.operator,
