var mathExamples = {
  ...
  'VaporCompressionCycle': [
    ...
    "fluid = 'R134a'     # Name of refrigerant",
    "mDot  = 1 kg/minute # Mass flow for all the system",
    "etaS  = 0.75        # Isentropic efficiency of compressor",
    "",
    "evap  = {T: -20 degC, P_drop :0 Pa, superHeating : 10 K}",
    "cond  = {T: 40 degC, P_drop: 0 Pa, subCooling : 10 K}",
    "",
    "# Store empty arrays for Temperature, Pressure, Density, Enthalpy and Entropy inside an object called c",
    "c = {T:[], P:[], D:[], H:[], S:[]};",
    "",
    "# Define low and high pressure",
    ...
    "# 4 to 1 Evaporation",
    "c.P[1] = pLow;",
    "c.T[1] = evap.T+ evap.superHeating;",
    "c.D[1] = props('D', 'T', c.T[1], 'P', c.P[1], fluid);",
    "c.H[1] = props('H', 'T', c.T[1], 'P', c.P[1], fluid);",
    "c.S[1] = props('S', 'T', c.T[1], 'P', c.P[1], fluid);",
    "",
    "# 1 to 2 Compression of vapor",
    "c.P[2] = pHigh;",
    "H_i    = props('H', 'P', c.P[2], 'S', c.S[1], fluid); # Enthalpy if compressor was 100% efficient",
    "c.H[2] = (H_i-c.H[1])/etaS + c.H[1];",
    "c.T[2] = props('T', 'P', c.P[2], 'H', c.H[2], fluid);",
    "c.D[2] = props('D', 'P', c.P[2], 'H', c.H[2], fluid);",
    "c.S[2] = props('S', 'P', c.P[2], 'H', c.H[2], fluid);",
    "",
    "# 2 to 3 Condensation",
    "c.P[3] = c.P[2]-cond.P_drop;",
    "c.T[3] = cond.T-cond.subCooling;",
    "c.D[3] = props('D', 'P', c.P[3], 'T', c.T[3], fluid);",
    "c.H[3] = props('H', 'P', c.P[3], 'T', c.T[3], fluid);",
    "c.S[3] = props('S', 'P', c.P[3], 'T', c.T[3], fluid);",
    "",
    "# 3 to 4 Expansion",
    "c.H[4] = c.H[3];",
    "c.P[4] = c.P[1]-evap.P_drop;",
    "c.T[4] = props('T', 'P', c.P[4], 'H', c.H[4], fluid);",
    "c.D[4] = props('D', 'P', c.P[4], 'H', c.H[4], fluid);",
    "c.S[4] = props('S', 'P', c.P[4], 'H', c.H[4], fluid);",
    "",
    "# Work and Energy",
    "W_comp = mDot*(c.H[2]-c.H[1]);",
    "Q_h    = mDot*(c.H[2]-c.H[3]);",
    "Q_c    = mDot*(c.H[1]-c.H[4]);",
    "",
    "# Display results",
    "\"Compressor power:\"",
    "W_comp to [W, BTU/h]",
