...
result_stage1 = solveODE(dydt, [t0, t_stage1, dt], x)
...
result_interstage = solveODE(dydt, [t_stage1, t_interstage, dt], x)
...
result_stage2 = solveODE(dydt, [t_interstage, t_stage2, dt], x)
...
result_unpowered1 = solveODE(dydt, [t_stage2, t_unpowered1, dt], x)
...
result_insertion = solveODE(dydt, [t_unpowered1, t_insertion, dt], x)
...
result_unpowered2 = solveODE(dydt, [t_insertion, t_unpowered2, dt], x)`
}
